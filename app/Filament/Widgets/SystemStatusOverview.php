    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('投票', $stats['votes'])
                ->description('加權使用者判斷'),
            Stat::make('今日待辦', $stats['pending_domains'] + $stats['pending_evidence_reports'] + $stats['pending_change_reports'] + $stats['open_abuse_events'] + $stats['pending_appeals'])
                ->description("站點 {$stats['pending_domains']} / 證據 {$stats['pending_evidence_reports']} / 改稿 {$stats['pending_change_reports']} / 濫用 {$stats['open_abuse_events']} / 申訴 {$stats['pending_appeals']}")
                ->color('warning'),
