    ...
    public function show(): JsonResponse
    {
        return response()->json([
            ...
            'endpoints' => [
                ...
                ['method' => 'GET', 'path' => '/api/news/status', 'description' => 'Weighted credibility status for a URL, including same-article cluster fields and evidence-weighted verdict.'],
                ['method' => 'POST', 'path' => '/api/news/snapshot', 'description' => 'Record article metadata snapshot and detect title/content/availability changes without storing full copyrighted text; canonical URL, content hash, and title help conservative same-article clustering.'],
                ...
                ['method' => 'GET', 'path' => '/api/news/evidence', 'description' => 'Evidence list with weighted helpfulness, direction summary, and preview metadata.'],
                ['method' => 'POST', 'path' => '/api/evidence/{vote}/reaction', 'description' => 'Rate evidence with helpfulness plus optional credibility, relevance, and supports/refutes/contextual direction.'],
