    ...
    public function show(): JsonResponse
    {
        return response()->json([
            ...
            'paths' => [
                ...
                '/api/traffic/events' => ['post' => ['summary' => 'Record privacy-first usage event']],
                '/api/traffic/events/batch' => ['post' => ['summary' => 'Record privacy-first usage event batch']],
                '/api/traffic/summary' => ['get' => ['summary' => 'Public aggregate traffic summary']],
