...
class ProductionBaselineSeeder extends Seeder
{
    ...
    private function newsDomains(): array
    {
        ...
        $domains = [
            ...
            ['domain' => 'ent.ltn.com.tw', 'outlet_name' => '自由娛樂', 'outlet_slug' => 'ltn-entertainment', 'article_url_pattern' => '^/news/(?:breakingnews/)?\\d+', 'blocked_path_pattern' => $blockedLists],
            ...
            ['domain' => 'tw.stock.yahoo.com', 'outlet_name' => 'Yahoo奇摩股市', 'outlet_slug' => 'yahoo-stock-tw', 'article_url_pattern' => '^/news/.+\\.html$', 'blocked_path_pattern' => $blockedLists],
            ['domain' => 'www.storm.mg', 'outlet_name' => '風傳媒', 'outlet_slug' => 'storm-media', 'article_url_pattern' => '^/(?:article|lifestyle|finance|money|world|politics|society|entertainment|sports|local|opinion)/\\d+', 'blocked_path_pattern' => $blockedLists],
            ['domain' => 'today.line.me', 'outlet_name' => 'LINE TODAY', 'outlet_slug' => 'line-today', 'article_url_pattern' => '^/tw/v3/article/[A-Za-z0-9_-]+', 'blocked_path_pattern' => $blockedLists],
            ['domain' => 'news.pchome.com.tw', 'outlet_name' => 'PChome 新聞', 'outlet_slug' => 'pchome-news', 'article_url_pattern' => '^/[A-Za-z0-9_-]+/[A-Za-z0-9_-]+/\\d{8}/index-[A-Za-z0-9_-]+\\.html$', 'blocked_path_pattern' => $blockedLists],
            ['domain' => 'www.twreporter.org', 'outlet_name' => '報導者', 'outlet_slug' => 'twreporter', 'article_url_pattern' => '^/a/', 'blocked_path_pattern' => $blockedLists],
