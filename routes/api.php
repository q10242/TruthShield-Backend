...
use App\Http\Controllers\Api\GlobalEntityController;
...
Route::post('/auth/{provider}/begin', [AuthController::class, 'oauthBegin'])->middleware('throttle:oauth');
Route::get('/auth/{provider}/redirect', [AuthController::class, 'socialiteRedirect'])->middleware('throttle:oauth');
Route::get('/auth/{provider}/socialite-callback', [AuthController::class, 'socialiteCallback'])->middleware('throttle:oauth');
Route::post('/auth/{provider}/callback', [AuthController::class, 'oauthCallback'])->middleware('throttle:oauth');
...
Route::get('/journalists/cache', [JournalistController::class, 'cache'])->middleware('throttle:60,1');
Route::get('/journalists', [JournalistController::class, 'index']);
Route::get('/journalists/{journalist}', [JournalistController::class, 'show']);
...
Route::get('/events/{event}/graph', [EventController::class, 'graph']);
Route::get('/events/{event}/edit-logs', [EventController::class, 'editLogs']);
Route::get('/global-entities', [GlobalEntityController::class, 'index']);
Route::get('/global-entities/{globalEntity}', [GlobalEntityController::class, 'show']);
